  ...
  return (
    <section id="visitanos" className="bg-stone text-paper">
      <div className="mx-auto grid max-w-5xl gap-12 px-4 py-20 sm:grid-cols-2">
        <Reveal>
          <h2 className="font-display text-3xl font-semibold tracking-tight">Visítanos</h2>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <a href={content.whatsappHref} className="btn-primary">
        ...
        <Reveal>
          <h3 className="text-sm font-semibold tracking-widest text-paper/75 uppercase">
            Horario
          </h3>
